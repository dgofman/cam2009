...
class Account {
	...
	function Account(){
		...
		$this->SCHEDULE="SELECT scheduleId, refScheduleId, startDate, endDate, smtwtfs, TIME_FORMAT(startTime, '%s') AS startTime, disposition, notes FROM lessonschedule WHERE lessoncontrolId=%s ORDER BY startDate, refScheduleId, startTime";
	...
	public function current($scheduleId, $refScheduleId, $startTime, $startDate, $endDate, $smtwtfs, $disposition="lesson taken", $notes=NULL){
		$mysql = MYSQL::getInstance();
